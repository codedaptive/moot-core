...
Current version: `v1.0.31` · generated from canonical source commit `88a99fed6`.
...
```swift
.package(url: "https://github.com/codedaptive/moot-core.git", from: "1.0.31")
```
...
```toml
[dependencies]
<crate-name> = { git = "https://github.com/codedaptive/moot-core", tag = "v1.0.31" }
```
