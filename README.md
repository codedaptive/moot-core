...
Current version: `v1.0.14` · generated from canonical source commit `cc4e5ad00`.
...
```swift
.package(url: "https://github.com/codedaptive/moot-core.git", from: "1.0.14")
```
...
```toml
[dependencies]
<crate-name> = { git = "https://github.com/codedaptive/moot-core", tag = "v1.0.14" }
```
