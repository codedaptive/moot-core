...
Current version: `v1.0.30` · generated from canonical source commit `8c8d6bcdb`.
...
```swift
.package(url: "https://github.com/codedaptive/moot-core.git", from: "1.0.30")
```
...
```toml
[dependencies]
<crate-name> = { git = "https://github.com/codedaptive/moot-core", tag = "v1.0.30" }
```
