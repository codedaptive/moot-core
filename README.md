...
Current version: `v1.0.24` · generated from canonical source commit `a17db6820`.
...
```swift
.package(url: "https://github.com/codedaptive/moot-core.git", from: "1.0.24")
```
...
```toml
[dependencies]
<crate-name> = { git = "https://github.com/codedaptive/moot-core", tag = "v1.0.24" }
```
