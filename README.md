...
Current version: `v1.0.25` · generated from canonical source commit `0c074c903`.
...
```swift
.package(url: "https://github.com/codedaptive/moot-core.git", from: "1.0.25")
```
...
```toml
[dependencies]
<crate-name> = { git = "https://github.com/codedaptive/moot-core", tag = "v1.0.25" }
```
