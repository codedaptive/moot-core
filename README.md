...
Current version: `v1.0.22` · generated from canonical source commit `5d94bcc7c`.
...
```swift
.package(url: "https://github.com/codedaptive/moot-core.git", from: "1.0.22")
```
...
```toml
[dependencies]
<crate-name> = { git = "https://github.com/codedaptive/moot-core", tag = "v1.0.22" }
```
